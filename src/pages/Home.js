  ...
  render() {
    return html`
      ...
      <div class="white window">
        ...
        <p>Democratic Capital is deployed on the <a $${this.link} href="https://optimism.io">Optimism Ethereum Layer 2 Network</a> in order to obtain fast transactions and low gas fees.</p>
        <h3>Verified Humans</h3>
        <p>Every user of Democratic Capital must verify as a unique human  on <a $${this.link} href="https://coinpassport.net/">Coinpassport</a>. This ensures that votes are fair and not determined solely by who has the biggest wallet.</p>
