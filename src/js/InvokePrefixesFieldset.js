...
export class InvokePrefixesFieldset extends BaseElement {
  static properties = {
  ...
  extractPrefixes() {
    return this.prefixes.split(',').filter(x => !!x);
  }
...
customElements.define('invoke-prefixes-fieldset', InvokePrefixesFieldset);
