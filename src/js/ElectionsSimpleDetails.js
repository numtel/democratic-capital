...
export class ElectionsSimpleDetails extends BaseElement {
  static properties = {
    address: {type: String},
    allowed: {type: String},
    _loading: {state: true},
  ...
  async connectedCallback() {
    ...
    this._loading = true;
    this.contract = await this.loadContract('ElectionsSimple', this.address);
...
customElements.define('elections-simple-details', ElectionsSimpleDetails);
